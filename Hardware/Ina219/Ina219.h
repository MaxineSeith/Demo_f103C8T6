...
#define IICINA219_GPIO_PORT               GPIOA
#define IICINA219_GPIO_SCL                GPIO_PIN_4
#define IICINA219_SCL_ENABLE()       do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)             /* PB口时钟使能 */

#define IICINA219_GPIO_PORT               GPIOA
#define IICINA219_GPIO_SDA                GPIO_PIN_3
#define IICINA219_SDA_ENABLE()       do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)             /* PB口时钟使能 */
...
//#define INA219_ADDRESS_5V 							        			(0x44<< 1)
//#define INA219_ADDRESS_8V 							        			(0x41<< 1)
//#define INA219_ADDRESS_10V							        			(0x45<< 1)

#define MAX_SHUNT_RANGE                     			(0x3E80)//0x7D00-320mV,0x3ED8-160mV,0x1F40-80mV,0x0FA0-40mV,
...
uint16_t INA219_ReadCurrent_raw(uint8_t Bddr);
//uint16_t INA219_ReadShuntVoltage_mV(uint8_t Bddr);
